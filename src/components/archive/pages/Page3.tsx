      ...
      <div className="body-text">
        ...
        <div className="two-col" style={{ marginTop: "10px" }}>
          <div className="col-entry">
            ...
            <div className="sub">
              COMMANDER, PROJECT STARFALL. RESPONSIBLE FOR ALL KINETIC AND
              CONTAINMENT ASSETS.
            </div>
          </div>
          <div className="col-entry">
            ...
            <div className="sub">
              CHIEF SCIENTIFIC OFFICER. LEAD ON PHYSICAL ANALYSIS AND LUNAR
              TELEMETRY.
            </div>
          </div>
          <div className="col-entry">
            <div className="name">
              AGENT K. <Redacted unlockCode="BLACKWOOD">BLACKWOOD</Redacted>
            </div>
            <div className="sub">
              FIELD OPERATIONS LEAD. LIAISON TO SITE CONTAINMENT AND RECOVERY.
            </div>
          </div>
          <div className="col-entry">
            <div className="name">MS. SARAH JENKINS</div>
            <div className="sub">
              CHIEF CRYPTO-LINGUISTICS. TASKED WITH DECODING THE STARFALL-1
              SIGNAL.
            </div>
          </div>
        </div>
