...
const Page24: React.FC = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", paddingBottom: "10px" }}>
      {/* Center Main Stamp */}
      <div style={{ textAlign: "center", margin: "10px 0 25px 0" }}>
        <div
      ...
      {/* Section Label */}
      <div className="section-label" style={{ color: "var(--blue-tab)", borderColor: "var(--blue-tab)" }}>
        {GAME_COMPLETE ? "FINAL ASSESSMENT — THE WITNESS" : "STATUS: RESTRICTED"}
      </div>
        ...
        {!GAME_COMPLETE ? (
          ...
          <>
            ...
            >
              ...
              <div style={{ fontSize: "11px", marginBottom: "5px", color: "var(--ink-faded)" }}>
              ...
              <div style={{ fontSize: "12px", fontStyle: "italic", lineHeight: "1.6" }}>
