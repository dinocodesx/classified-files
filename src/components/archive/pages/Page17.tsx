    ...
    <div>
      ...
      <div className="body-text">
        ...
        <p className="indent">
          ...
          designated <Redacted unlockCode="GHOST">GHOST_IN_SHELL</Redacted>, has
          bypassed the kernel security and is executing self-replicating code
          across all connected IMPs. It is not just data; it is a bio-electrical
